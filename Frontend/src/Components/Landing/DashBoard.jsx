...
import AppModal from "../../assets/Custom/DynamicModal/AppModal";
import AddTeamMemberForm from "../TeamMember/AddTeamMemberForm";
...
const DashBoard = () => {
  ...
  return (
    <div className="db-root">
      ...
      >
        <AddTeamMemberForm onClose={() => setOpenModal(false)} />
      </AppModal>
        ...
        <div className="db-bottom-grid">
          ...
          <div className="db-card">
            <div className="db-card-header">
              ...
              <button type="button" className="db-chip" onClick={() => {
                setOpenModal(true);
                setModalData({
